...
from lib.models.atatrack.vit_cae_async import CAE_Base_patch16_224_Async
...
class ATATrack(nn.Module):
    """ This is the base class for ATATrack """
...
def build_ATATrack(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(
        __file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('ATATrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'ATATrack' in cfg.MODEL.PRETRAIN_FILE and training:
